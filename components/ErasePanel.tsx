...
const ErasePanel: React.FC<ErasePanelProps> = ({ onRemoveBackground, isLoading }) => {
  return (
    <div className="w-full bg-gray-800/50 border border-gray-700 rounded-lg p-4 flex flex-col items-center gap-4 animate-fade-in backdrop-blur-sm">
      <h3 className="text-lg font-semibold text-gray-300">Smart Background Removal</h3>
      <p className="text-sm text-gray-400 -mt-2">Automatically remove image background. Perfect for creating transparent PNG images.</p>
